    ...
    private func listTrajectory(runways:[DataRunway]) -> [DataTrajectory] {
        ...
        for runwayData in runways {
            ...
            let tmp = DataTrajectory(time_curveFirst: trajPtr.pointee.time_curveFirst,
                                     ...
                                     firstCurveHalf_lat: trajPtr.pointee.firstCurveHalf_lat,
                                     firstCurveHalf_lon: trajPtr.pointee.firstCurveHalf_lon,
                                     ...
                                     secondCurveHalf_lat: trajPtr.pointee.secondCurveHalf_lat,
                                     secondCurveHalf_lon: trajPtr.pointee.secondCurveHalf_lon,
