...
Seg2 model_wind(Seg path_with_spiral, Packet data)
{
    ...
    Curve augmented_curve_B= wind_curveB(path_with_spiral,WIND_HEADING, WIND_VELOCITY,OMEGA_30_DEGREE_BANK, min_radius, augmented_SLS, angle,baseline_g, data.airspeed); //send second curve to be modified
    ...
    {
        augmented_spiral= wind_spiral(path_with_spiral,WIND_HEADING, WIND_VELOCITY,OMEGA_30_DEGREE_BANK, min_radius, augmented_curve_B, angle,baseline_g, data.airspeed);
...
int TrajectoryCal(){
    ...
    double EMERGENCY_ALTITUDE =  5000.0/364173.0;// in units
